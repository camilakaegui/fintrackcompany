      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-6 sm:p-8 rounded-3xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">Inicia sesión</h1>
            <p className="text-sm sm:text-base text-muted-foreground">
              Conecta tu cuenta de Google para sincronizar tus transacciones bancarias automáticamente
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold h-14 text-base disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
